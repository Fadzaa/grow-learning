...
class ProfilePageView extends GetView<ProfilePageController> {
  ...
  final FriendsPageController friendsPageController = Get.put(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text('Profile', style: tsTitleMedium.copyWith(
              ...
              children: [
                Column(
                  children: [
                    ...
                    SizedBox(height: 20,),
                    Text('Kita Poke', style: tsTitleSmall.copyWith(
                        color: blackColor, fontWeight: FontWeight.w600),),
                    SizedBox(height: 20,),
                    Text('Rekayasa Perangkat Lunak',
                      style: tsBodyLarge.copyWith(
                          color: greySoft, fontWeight: FontWeight.w500),),
                  ],
                ),
                SizedBox(height: 30,),
                Row(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 15,),
                          Text('3', style: tsBodyLarge.copyWith(
                              color: blackColor, fontWeight: FontWeight.w600),),
                          SizedBox(height: 10,),
                          Text('Day Streak', style: tsBodyMedium.copyWith(
                              color: greySoft, fontWeight: FontWeight.w600),),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('3', style: tsBodyLarge.copyWith(
                              color: blackColor, fontWeight: FontWeight.w600),),
                          SizedBox(height: 10,),
                          Text('Xp Total', style: tsBodyMedium.copyWith(
                              color: greySoft, fontWeight: FontWeight.w600),),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('3', style: tsBodyLarge.copyWith(
                              color: blackColor, fontWeight: FontWeight.w600),),
                          SizedBox(height: 10,),
                          Text('League', style: tsBodyMedium.copyWith(
                              color: greySoft, fontWeight: FontWeight.w600),),
                        ],
                      ),
                    ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Text('SHARE MY PROGRESS',
                              style: tsBodyLarge.copyWith(color: blackColor,
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Obx(() {
                        return Text('Friends (${friendsPageController
                            .all_friends.length})',
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text('Kita Poke', style: tsBodyLarge.copyWith(
                              color: blackColor, fontWeight: FontWeight.w600),),
                        ],
                      ),
                      Row(
                        children: [
                          SvgPicture.asset(icElectric, width: 30, height: 30,),
                          SizedBox(width: 10,),
                          Text('872', style: tsBodyLarge.copyWith(
                              color: blackColor, fontWeight: FontWeight.w600),),
                        ],
                      ),
                    ],
                ...
                Row(
                  ...
                  children: [
                    Text('Badges', style: tsTitleSmall.copyWith(
                        color: blackColor, fontWeight: FontWeight.w600),),
                  ],
                ),
                SizedBox(height: 20,),
                          ...
                          Column(
                            ...
                            children: [
                              Text('Kita Poke', style: tsBodyLarge.copyWith(
                                  color: blackColor,
                                  fontWeight: FontWeight.w600),),
                              Text('poke tetaplah poke, akokawo',
                                style: tsBodyMedium.copyWith(color: greySoft,
                                    fontWeight: FontWeight.w600),),
                            ],
                          ),
                        ],
